                ...
                @foreach($books as $book)
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden card-hover cursor-pointer"
                        ...
                        <div class="p-6">
                            ...
                            <div class="mb-4">
                                    <p class="ml-2 text-sm text-gray-500 line-clamp-3">Penulis: {{ $book->penulis }}</p>
                                    <p class="ml-2 text-sm text-gray-500 line-clamp-3">Penerbit: {{ $book->penerbit }}</p>                                                                    
                            </div>
                            <div>
                            <p class="ml-2 text-sm text-gray-500 line-clamp-3">Deskripsi: {{ $book->deskripsi }}</p>
                            </div>
                        </div>
                    </div>
                @endforeach
