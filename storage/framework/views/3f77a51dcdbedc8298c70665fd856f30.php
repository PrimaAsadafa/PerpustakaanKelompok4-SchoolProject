...
<body class="gradient-background min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-black">Perpustakaan Digital</h1>
            <p class="mt-2 text-black/80">Login Administrator</p>
        </div>

        <div class="glass-effect rounded-2xl shadow-2xl p-8 transform hover:scale-[1.02] transition-all duration-300">
            <!-- Login Form -->
            <form action="<?php echo e(route('login.attempt')); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    <button type="submit" 
                            class="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm 
                                   text-sm font-medium text-white bg-gradient-to-r bg">
                        Login
                    </button>
                </div>
            </form>
            ...
            <p class="mt-6 text-center text-sm text-gray-600">
                    Belum punya akun? 
                    <a href="<?php echo e(route('register')); ?>" class="font-medium text-black">
                        Register disini
                    </a>
                </p>
...
<?php /**PATH C:\Users\ASUS\Documents\Perpustakaan\resources\views/auth/login.blade.php ENDPATH**/ ?>