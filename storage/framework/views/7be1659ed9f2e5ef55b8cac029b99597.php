        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex items-center space-x-4">
                    <a href="<?php echo e(route('home')); ?>" class="text-black">
                        Beranda
                    </a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden card-hover">
                <div class="p-8">
                    ...
                    <p class="text-3xl font-bold text-gray-900 mb-4"><?php echo e(\App\Models\Book::count()); ?></p>
                    <a href="<?php echo e(route('home')); ?>" class="text-gray-400 hover:text-black inline-flex items-center font-medium">
                        Lihat Semua Buku
...
<?php /**PATH C:\Users\ASUS\Documents\Perpustakaan\resources\views/member/dashboard.blade.php ENDPATH**/ ?>