...
<body class="bg-gray-50 shadow-xl" x-data="{ 
    previewUrl: null,
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden animate-slideIn" style="animation-delay: 0.1s">
            <form action="<?php echo e(route('admin.books.store')); ?>" method="POST" enctype="multipart/form-data" class="divide-y divide-gray-200">
                <?php echo csrf_field(); ?>
                <div class="px-8 py-8">
                    <!-- Validation Errors -->
                    <?php if($errors->any()): ?>
                    ...
                    <div class="grid grid-cols-1 gap-y-8 gap-x-4 sm:grid-cols-6">
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-1">
                                <input type="text" name="judul" id="judul" 
                                       class="block w-full rounded-lg border-black shadow-sm focus:ring-2 focus:ring-indigo-500 
                                              focus:outline-none transition-all duration-300 py-3 px-4"
                            ...
                            <div class="mt-1">
                                <select name="kategori" id="kategori"
                                    ...
                                    <?php $__currentLoopData = $kategoriOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($value); ?>" <?php echo e(old('kategori') == $value ? 'selected' : ''); ?>>
                                            <?php echo e($label); ?>
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-1">
                                <input type="text" name="penulis" id="penulis" 
                                       ...
                                       value="<?php echo e(old('penulis')); ?>" required>
                            </div>
                        </div>
                        ...
                        <!-- Hanya teks sinopsis, tanpa opsi gambar -->
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <textarea name="abstrak_text" rows="4"
                                          class="block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-indigo-500 
                                                 focus:outline-none transition-all duration-300 py-3 px-4"
                                          placeholder="Masukkan sinopsis buku dalam bentuk teks"><?php echo e(old('abstrak_text')); ?></textarea>
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-black transition-colors duration-300">
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600 mt-4">
                                        <label for="thumbnail" class="relative cursor-pointer rounded-md font-medium text-gray hover:text-black">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-black transition-colors duration-300">
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600 mt-4">
                                        <label for="file" class="relative cursor-pointer rounded-md font-medium text-gray hover:black">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                                <input type="number" name="tahun_terbit" id="tahun_terbit" 
                                       ...
                                       value="<?php echo e(old('tahun_terbit')); ?>" required>
                            </div>
                        </div>
                ...
                <div class="px-8 py-5 bg-gray-50">
                    <button type="submit"
                            class="w-full sm:w-auto inline-flex justify-center py-3 px-8 border border-transparent shadow-sm text-sm font-medium 
                                   rounded-lg text-white submit-button">
                        Simpan Buku
                    </button>
                </div>
            </form>
...
<?php /**PATH C:\Users\ASUS\Documents\Perpustakaan\resources\views/admin/books/create.blade.php ENDPATH**/ ?>