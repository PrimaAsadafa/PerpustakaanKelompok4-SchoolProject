...
<body class="bg-gray-50" x-data="{ 
    previewUrl: '<?php echo e($book->thumbnail_path ? asset('storage/' . $book->thumbnail_path) : null); ?>',
    abstrakPreviewUrl: '<?php echo e($book->abstrak_image_path ? asset('storage/' . $book->abstrak_image_path) : null); ?>',
    abstrakType: '<?php echo e($book->abstrak_text ? 'text' : 'image'); ?>',
    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div class="md:flex md:items-center md:justify-between mb-6 animate-slideIn">
            <div class="flex-1 min-w-0">
                <h2 class="text-3xl font-bold leading-7 text-gray-900 sm:truncate">
                    Edit Buku: <?php echo e($book->judul); ?>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden animate-slideIn" style="animation-delay: 0.1s">
            <form action="<?php echo e(route('admin.books.update', $book)); ?>" method="POST" enctype="multipart/form-data" class="divide-y divide-gray-200">
                <?php echo csrf_field(); ?>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <h3 class="text-sm font-medium text-red-800">
                                        Terdapat <?php echo e($errors->count()); ?> kesalahan pada form:
                                    </h3>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                                <select name="kategori" id="kategori"
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-indigo-500 
                                           focus:border-transparent transition-all duration-300 py-3 px-4">
                                    <?php $__currentLoopData = $kategoriOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($value); ?>" <?php echo e((old('kategori', $book->kategori) == $value) ? 'selected' : ''); ?>>
                                            <?php echo e($label); ?>
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-1">
                                <input type="text" name="penulis" id="penulis" 
                                       class="block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-indigo-500 
                                              focus:border-transparent transition-all duration-300 py-3 px-4"
                                       value="<?php echo e(old('penulis', $book->penulis)); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                                <input type="text" name="penerbit" id="penerbit" 
                                       class="block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-indigo-500 
                                              focus:border-transparent transition-all duration-300 py-3 px-4"
                                       value="<?php echo e(old('penerbit', $book->penerbit)); ?>" required>
                            </div>
                        </div>
                            ...
                            <div class="mt-1 space-y-4">
                                ...
                                <div x-show="abstrakType === 'text'">
                                    <textarea name="abstrak_text" rows="4"
                                              class="block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-indigo-500 
                                                     focus:border-transparent transition-all duration-300 py-3 px-4"
                                              placeholder="Masukkan abstrak buku dalam bentuk text"><?php echo e(old('abstrak_text', $book->abstrak_text)); ?></textarea>
                                        ...
                                        <div class="space-y-1 text-center">
                                            ...
                                            <div class="flex text-sm text-gray-600 mt-4">
                                                <label for="abstrak_image" class="relative cursor-pointer rounded-md font-medium text-indigo-600 hover:text-indigo-500">
                                                    <span><?php echo e($book->abstrak_image_path ? 'Ganti gambar abstrak' : 'Upload gambar abstrak'); ?></span>
                                                    <input id="abstrak_image" name="abstrak_image" type="file" accept="image/*" class="sr-only"
                                                           @change="handleAbstrakImageChange">
                                                </label>
                                            </div>
                                            <?php if($book->abstrak_image_path): ?>
                                                <p class="text-xs text-gray-500 mt-2">File saat ini: <?php echo e(basename($book->abstrak_image_path)); ?></p>
                                            <?php endif; ?>
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600 mt-4">
                                        <label for="file" class="relative cursor-pointer rounded-md font-medium text-indigo-600 hover:text-indigo-500">
                                            <span><?php echo e($book->file_path ? 'Ganti PDF' : 'Upload PDF'); ?></span>
                                            <input id="file" name="file" type="file" accept=".pdf" class="sr-only">
                                        </label>
                                    </div>
                                    <?php if($book->file_path): ?>
                                        <p class="text-xs text-gray-500 mt-2">File saat ini: <?php echo e(basename($book->file_path)); ?></p>
                                    <?php endif; ?>
                                    <p class="text-xs text-gray-500 mt-2">
                                        PDF hingga 10MB
                                    </p>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-1">
                                <input type="number" name="tahun_terbit" id="tahun_terbit" 
                                       ...
                                       value="<?php echo e(old('tahun_terbit', $book->tahun_terbit)); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <textarea id="deskripsi" name="deskripsi" rows="4"
                                          class="block w-full rounded-lg border-gray-300 shadow-sm focus:ring-2 focus:ring-indigo-500 
                                                 focus:border-transparent transition-all duration-300 py-3 px-4"
                                          required><?php echo e(old('deskripsi', $book->deskripsi)); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\Users\ASUS\Documents\Perpustakaan\resources\views/admin/books/edit.blade.php ENDPATH**/ ?>