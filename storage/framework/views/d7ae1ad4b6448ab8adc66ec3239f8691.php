        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="mb-8 p-4 bg-gray-50 rounded-lg">
                ...
                <div class="flex items-start space-x-4">
                    ...
                    <?php endif; ?>
                    <div>
                        <h4 class="font-medium text-lg"><?php echo e($book->judul); ?></h4>
                        <p class="text-sm text-gray-600">Tahun Terbit: <?php echo e($book->tahun_terbit); ?></p>
                    </div>
                </div>
            </div>

            <!-- Form Peminjaman -->
            <form action="<?php echo e(route('peminjaman.store')); ?>" method="POST" x-data="{ 
                tanggalPinjam: '<?php echo e(old('tanggal_pinjam', date('Y-m-d'))); ?>',
                tanggalKembali: '<?php echo e(old('tanggal_kembali', date('Y-m-d', strtotime('+1 day')))); ?>',
                durasi: 0,
                maxDurasi: 7,
                hitungDurasi() {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\Documents\Perpustakaan\resources\views/peminjaman/create.blade.php ENDPATH**/ ?>